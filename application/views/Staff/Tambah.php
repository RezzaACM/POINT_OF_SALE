...
<form action="<?php echo base_url('staff/tambah_act')?>" method="post">
    ...
    <div class="col-md-12">
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-9">
                    <textarea required class="form-control" name="alamat" id="alamat" cols="22" rows="10"></textarea>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group">
            <div class="row">
                <label for="alamat" class="control-label col-md-3">Jabatan</label>
                <div class="col-md-9">
                    <input required class="form-control" name="jabatan" id="alamat" cols="22" rows="10"> 
                </div>
            </div>
        </div>
    </div>
