...
<div class="col-md-12">
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-9">
                <input type="text" name="nama_item" id="nama" class="form-control" placeholder="Masukan Nama Item" value="<?php echo $itemId[0]->nama_item ?>" readonly required>
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-9">
                    <input readonly class="form-control" type="text" value="<?php echo $itemId[0]->kategori?>">
            </div>
        </div>
    </div>
    <div class="form-group">
